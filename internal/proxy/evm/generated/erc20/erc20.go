...
func (_ERC20 *ERC20Transactor) BurnFrom(opts *bind.TransactOpts, payer_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "burnFrom", payer_, amount_)
}

// BurnFrom is a paid mutator transaction binding the contract method 0x79cc6790.
//
// Solidity: function burnFrom(address payer_, uint256 amount_) returns()
func (_ERC20 *ERC20Session) BurnFrom(payer_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.BurnFrom(&_ERC20.TransactOpts, payer_, amount_)
}

// BurnFrom is a paid mutator transaction binding the contract method 0x79cc6790.
//
// Solidity: function burnFrom(address payer_, uint256 amount_) returns()
func (_ERC20 *ERC20TransactorSession) BurnFrom(payer_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.BurnFrom(&_ERC20.TransactOpts, payer_, amount_)
}
...
func (_ERC20 *ERC20Transactor) MintTo(opts *bind.TransactOpts, receiver_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "mintTo", receiver_, amount_)
}

// MintTo is a paid mutator transaction binding the contract method 0x449a52f8.
//
// Solidity: function mintTo(address receiver_, uint256 amount_) returns()
func (_ERC20 *ERC20Session) MintTo(receiver_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.MintTo(&_ERC20.TransactOpts, receiver_, amount_)
}

// MintTo is a paid mutator transaction binding the contract method 0x449a52f8.
//
// Solidity: function mintTo(address receiver_, uint256 amount_) returns()
func (_ERC20 *ERC20TransactorSession) MintTo(receiver_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.MintTo(&_ERC20.TransactOpts, receiver_, amount_)
}
