...
func (_ERC721 *ERC721Transactor) BurnFrom(opts *bind.TransactOpts, payer_ common.Address, tokenId_ *big.Int) (*types.Transaction, error) {
	return _ERC721.contract.Transact(opts, "burnFrom", payer_, tokenId_)
}

// BurnFrom is a paid mutator transaction binding the contract method 0x79cc6790.
//
// Solidity: function burnFrom(address payer_, uint256 tokenId_) returns()
func (_ERC721 *ERC721Session) BurnFrom(payer_ common.Address, tokenId_ *big.Int) (*types.Transaction, error) {
	return _ERC721.Contract.BurnFrom(&_ERC721.TransactOpts, payer_, tokenId_)
}

// BurnFrom is a paid mutator transaction binding the contract method 0x79cc6790.
//
// Solidity: function burnFrom(address payer_, uint256 tokenId_) returns()
func (_ERC721 *ERC721TransactorSession) BurnFrom(payer_ common.Address, tokenId_ *big.Int) (*types.Transaction, error) {
	return _ERC721.Contract.BurnFrom(&_ERC721.TransactOpts, payer_, tokenId_)
}
...
func (_ERC721 *ERC721Transactor) MintTo(opts *bind.TransactOpts, receiver_ common.Address, tokenId_ *big.Int, tokenURI_ string) (*types.Transaction, error) {
	return _ERC721.contract.Transact(opts, "mintTo", receiver_, tokenId_, tokenURI_)
}

// MintTo is a paid mutator transaction binding the contract method 0x9f6ed25f.
//
// Solidity: function mintTo(address receiver_, uint256 tokenId_, string tokenURI_) returns()
func (_ERC721 *ERC721Session) MintTo(receiver_ common.Address, tokenId_ *big.Int, tokenURI_ string) (*types.Transaction, error) {
	return _ERC721.Contract.MintTo(&_ERC721.TransactOpts, receiver_, tokenId_, tokenURI_)
}

// MintTo is a paid mutator transaction binding the contract method 0x9f6ed25f.
//
// Solidity: function mintTo(address receiver_, uint256 tokenId_, string tokenURI_) returns()
func (_ERC721 *ERC721TransactorSession) MintTo(receiver_ common.Address, tokenId_ *big.Int, tokenURI_ string) (*types.Transaction, error) {
	return _ERC721.Contract.MintTo(&_ERC721.TransactOpts, receiver_, tokenId_, tokenURI_)
}
