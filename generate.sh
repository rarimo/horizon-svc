...
GENERATED="$(go env GOPATH)/src/github.com/rarimo/horizon-svc/resources"
OPENAPI_DIR="$(go env GOPATH)/src/github.com/rarimo/horizon-svc/docs/web_deploy"
...
function generate {
    ...
    docker run -v "${OPENAPI_DIR}":/openapi -v "${GENERATED}":/generated "${GENERATOR_IMAGE}" generate -pkg "${PACKAGE_NAME}" --raw-formats-as-types --meta-for-lists
